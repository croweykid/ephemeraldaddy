...
def test_rectification_range_chart_output_samples_start_midpoint_and_end():
    ...
    assert "range_minutes = rectification_range_minutes(chart)" in method
    assert '("start", start_minute)' in method
    assert '("midpoint", midpoint)' in method
    assert '("end", end_minute)' in method
