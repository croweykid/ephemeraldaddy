...
def test_tag_manager_category_drop_treats_payload_as_command_not_model_move():
    ...
    assert "_defer_tag_category_assignment(self, category_prefix, labels)" in hierarchy_drop
...
def test_tag_manager_category_list_drop_treats_payload_as_command_not_model_move():
    ...
    assert "_defer_tag_category_assignment(self, category_prefix, labels)" in category_list_drop
