...
def test_section_refresh_limits_snapshot_work_to_requested_sections():
    assert "computed_sections = (\n                frozenset(sections_to_refresh)" in APP_SOURCE
    assert "self._refresh_database_metrics_cache(\n                    force_full_refresh=force_full_refresh,\n                    computed_sections=computed_sections," in APP_SOURCE
