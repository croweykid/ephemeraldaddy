...
3. **Fantasy RPG classifiers exist in multiple generations (`v1`, `v2`, `v2_subclasses`)**
...
- **Higher risk:** #2 (legacy full app), #3 (versioned Fantasy RPG logic), #5 (split Human Design derivation behavior).
...
3. Consolidate Fantasy RPG logic to one generation and move old modules behind explicit `legacy` namespace or delete.
