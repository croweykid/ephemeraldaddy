...
class ChartAnalysisSectionsController:
    ...
    def create_sections(self, panel: QWidget) -> None:
        ...
        self.add_section(
            ...
            header_title="Dominant planets",
            subtitle_text="Planets evaluated with priority weights (rulerships/houses/signs/etc).",
            subtitle_by_mode={
                "dominant_planets": "Planets evaluated with priority weights (rulerships/houses/signs/etc).",
                "sidereal_planet_prevalence": "Planets mapped from each body's nakshatra ruler (equally weighted).",
            },
