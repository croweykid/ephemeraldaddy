...
def _build_predictions_panel(owner: QWidget) -> QWidget:
    ...
    owner.predictions_background_status_label = QLabel("Traits render on demand in the background.")
    owner.predictions_background_status_label.setObjectName("traits_prediction_status_label")
    ...
    owner.predictions_background_status_label.setVisible(False)
    traits_section_layout.addWidget(owner.predictions_background_status_label)
