...
policy controls and anti-trait file importing are layered here so the manager
stays focused on Trait files and the public import path remains unchanged.
"""

from __future__ import annotations

from ephemeraldaddy.gui.features.settings import traits_manager as _core
from ephemeraldaddy.gui.features.settings.trait_anti_import import (
    install_trait_anti_import as _install_trait_anti_import,
)
...
_install_trait_anti_import(_core)
