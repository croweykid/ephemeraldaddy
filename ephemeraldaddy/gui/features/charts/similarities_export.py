...
SIMILARITIES_JSON_SECTION_CATEGORIES: dict[str, str] = {
    ...
    "Elemental Dominance in common": "elements",
    "Modal Dominance in common": "modes",
    ...
    "Elemental Dominance in contrast": "antielements",
    "Modal Dominance in contrast": "antimodes",
