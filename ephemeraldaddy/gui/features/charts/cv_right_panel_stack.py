...
def build_chart_right_panel_stack(
    *,
    ...
    predictions_scroll.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
    ...
    subjective_notes_scroll.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
