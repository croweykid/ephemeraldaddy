...
class ChartEditorRightPanelController:
    ...
    def set_active_panel(
        ...
        *,
        ...
        # A stacked page becomes visible before every descendant has necessarily
        # consumed its viewport geometry. The controller receives this operation
        # explicitly rather than discovering a private ChartEditorWindow method.
...
# Transitional public alias for callers migrating from the legacy controller path.
ChartRightPanelController = ChartEditorRightPanelController
