...
class ManageChartsDialog(DatabaseAnalyticsChartsMixin, QDialog):
    ...
    def _build_edit_panel(self) -> QWidget:
        ...
        self.batch_new_chart_button.setToolTip("+ New Chart")
        ...
        self.batch_delete_chart_button.setToolTip("Delete Charts")
        ...
        self.batch_rename_chart_button.setToolTip("Rename chart")
        ...
        self.batch_synastry_chart_button.setToolTip("Synastry Chart")
        ...
        self.batch_export_selection_button.setToolTip("Export Selection to CSV")
        ...
        self.batch_import_csv_button.setToolTip("Import from CSV")
        ...
        self.batch_backup_database_button.setToolTip("Backup Database")
        ...
        self.batch_restore_database_button.setToolTip("Restore Database")
        ...
        self.batch_append_database_button.setToolTip("Append Database")
        ...
        self.batch_refresh_database_button.setToolTip("Refresh Database")
