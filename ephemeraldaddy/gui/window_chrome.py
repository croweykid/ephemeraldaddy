...
def configure_main_window_chrome(window: "QMainWindow") -> None:
    ...
    _bind_menu_action(charts_menu, "New Chart", window, "on_new_chart")
    _bind_menu_action(charts_menu, "Get Personal Transit", window, "on_menu_get_personal_transit_active_chart")
    _bind_menu_action(charts_menu, "Export Chart as MD/TXT", window, "on_menu_export_chart_as_md_txt_active_chart")

    tools_menu = menu_bar.addMenu("Tools")
    _bind_menu_action(tools_menu, "Settings", window, "_on_open_settings", "on_open_settings")
    _bind_menu_action(tools_menu, "Interpret Astro Age", window, "on_menu_interpret_astro_age_active_chart")
    _bind_menu_action(tools_menu, "Create Gemstone Chart", window, "on_menu_create_gemstone_chart_active_chart")

    view_menu = menu_bar.addMenu("View")
    _bind_menu_action(view_menu, "General Population Comparison", window, "on_menu_open_general_population_comparison")
    _bind_menu_action(view_menu, "Manage Collections", window, "on_menu_manage_collections")
...
def configure_manage_dialog_chrome(dialog: "QWidget", layout: "QLayout") -> None:
    ...
    _bind_menu_action(charts_menu, "Export Chart as MD/TXT", dialog, "_on_menu_export_chart_md_txt")
    ...
    _bind_menu_action(tools_menu, "Interpret Astro Age", dialog, "_on_menu_tools_interpret_astro_age")
    ...
    _bind_menu_action(view_menu, "General Population Comparison", dialog, "_on_menu_general_population_comparison")
    _bind_menu_action(view_menu, "Manage Collections", dialog, "_on_menu_manage_collections")
