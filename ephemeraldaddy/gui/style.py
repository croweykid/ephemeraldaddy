...
SETTINGS_SECTION_SUBHEADER_STYLE = (
    f"{COLLAPSIBLE_SECTION_SUBHEADER_STYLE} font-weight: 700;"
)
...
SETTINGS_TAB_BUTTON_CHECKED_STYLE = (
    ...
    f"border: 1px solid {COLOR_ACCENT_WARNING};"
    "color: #111111;"
)
...
ABC_PANEL_SECTION_FRAME_MARGINS = (8, 4, 8, 8)
ABC_PANEL_SECTION_FRAME_SPACING = 0
