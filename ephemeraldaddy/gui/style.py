...
APP_CLICKABLE_CURSOR = Qt.PointingHandCursor
APP_POPOUT_CURSOR = APP_CLICKABLE_CURSOR
APP_BUTTON_CURSOR = APP_CLICKABLE_CURSOR
...
def apply_clickable_cursor(widget: QWidget) -> None:
    """Use the appwide pointing-hand cursor for generic clickable widgets."""
    widget.setCursor(APP_CLICKABLE_CURSOR)
