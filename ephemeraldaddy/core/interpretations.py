...
#Positions and aspects must be parsed differently. First, parse the position string so it's algorithmically recognizeable with actual chart positions in the given chart. Then - if take that chart's sign weight, body weight and house weight
    ...
    "gates":{7,62,4,42,61,37},
    "antigates":{34,57,18,19,60,5,56},
    "channels":{{24,61}},},
    ...
    "quotes":{"'I don't care it  it hurts. / I want to have control. / I want a perfect body. / I want a perfect soul.' - Thom Yorke, Creep"},},
    2:{ #Ojo: sample size was ONLY 22 when I did this, so it will need to be reevaluated!
    ...
    "antisigns":{"Gemini","Scorpio","Taurus"},
    "houses":{11,4,6,}, #10 came up also, but I think it is probably due to a lot of the people being famous?? 11 may also be due to that, but we'll see.
    "antihouses":{},
    "bodies":{"Venus","Ceres","Chiron","Neptune"}, #Venus was the biggest indicator! But is that because they were known for being service-oriented??
    "antibodies":{"Mars","Pluto","Moon"}, #moon is looking out for #1, evidently
    "nakshatras":{"Purva Ashadha","Pushya","Shatabhisha"},
    "antinakshatras":{}, #none so far.
    "positions":{"Mars in Cancer","Moon in Pisces","Neptune in Capricorn","Pluto in Scorpio","Juno in Scorpio","Jupiter in Aries","Neptune in Libra","Pallas in Aquarius","Fortune in Capricorn","Saturn in Aquarius","Vesta in Cancer","Vesta in Sagittarius","Ceres in Aquarius","Chiron in Leo","Jupiter in Cancer","Jupiter in Virgo","Ketu in Aquarius","Mercury in Libra","Sun in Capricorn","True Lilith in Leo","AS in Cancer","AS in Capricorn","Juno in Cancer","Pallas in Scorpio",},
    ...
    "antipositions":{"Chiron in Pisces","Chiron in Aries","Taurus in H1","Venus in Libra","Venus in Pisces","Gemini in H1","Uranus in Aries","Sun in Pisces","Pluto in Virgo",}, 
    ...
    "antiaspects":{},
    "gates":{58,45,47,52,13,17,39,46,62,38,53,63},
    "antigates":{33,43,34,57,64,61,9,14,2,23,24,51},
    "channels":{},
    "antichannels":{},
    "color":"#cc9900",
    ...
    "antichannels":{},
    "color":"#ffff00",
    "motivation":"Visible recognitition, status and achievement",
    "description":"3s are sort of narcissist-coded, but that doesn't have to be malignant. It can result in materialism, or it could result in extreme competence. Sometimes 3s are mistaken for 1s because they appear driven by perfectionism. But rather than pursuit of perfection/ideals (e1) or competence (e5) for their own sake, 3s are driven by the pursuit of recognition for that competence. Arguably, the easier the trophies and acolades come, the less hard 3s will need to try. The point here is not the conditions of victory, but the recognition of their superiority over others; the status and attention of being president more than the power of owning the red button. They will live and die for that gold star on their paper, and the knowledge that other people know they got it.",
    "quotes":{"'There's been a lot of compromisin' / on the road to my horizon... / but I'm gonna be / where the lights are shinin' on me...' - Glen Camphell, Rhinestone Cowboy"},},
    4:{
    ...
    5:{
    "signs":{"Gemini","Aquarius","Aries"},
    "antisigns":{"Cancer","Leo",},
    "houses":{3,9},
    "antihouses":{},
    "bodies":{"Mercury","Pluto","Pallas"},
    "antibodies":{},
    "nakshatras":{"Swati","Anuradha","Shatabhisha","Kritikka"},
    "antinakshatras":{}, 
    "positions":{"Mercury in Gemini","Mercury in Virgo","Mercury in Scorpio","Mercury in Aquarius"},
    "antipositions":{},
    "aspects":{},
    "antiaspects":{},
    "gates":{},
    ...
    "bodies":{"Moon","Saturn"},
    "antibodies":{},
    "nakshatras":{"Uttara Ashadha","Pushya"},
    "antinakshatras":{}, 
    "positions":{},
    "antipositions":{},
    "antipositions":{},
    ...
    "bodies":{"Mars","Pluto"},
    "antibodies":{"Neptune",""},
    "nakshatras":{"Jyestha","Purva Bhadrapada","Krittika","Chitra"},
    "antinakshatras":{}, 
    "positions":{"Moon in Aries"},
    "antipositions":{},
    "aspects":{},
    "antiaspects":{},
    "gates":{},
    ...
    9:{
    "signs":{"Pisces","Libra","Scorpio"},
    "antisigns":{},
    "houses":{12},
    "antihouses":{},
    "bodies":{"Neptune"},
    "antibodies":{"Mars"},
    "nakshatras":{"Dhanishta","Uttara Bhadrapada","Ashwini"},
    "antinakshatras":{}, 
    "positions":{""},
    "antipositions":{},
    "aspects":{},
    ...
    "antichannels":{},
    "color":"#cc99ff",
    "motivation":"Tranquility. Maintaining harmony at any cost","description":"9s just want peace. They want everyone to get along. Unlike 1s, they won't generally lash out at those disrupting the peace, but will quietly brood and retreat from those who cause chaos and disharmony. If they ever choose to stand for anything, it would likely be a stand for nonviolence, a stand to end conflict. They can be hard to recognize because they often adapt & shapeshift as a means of keeping peace.","quotes":{"'Well, you may say that I'm a dreamer / but I'm not the only one. / I hope someday you'll join us... / and the world can live as one.' - John Lennon, Imagine"},},
