...
SIGN_KEYWORDS_CANONICAL = {
    "aries": {
        ...
        "talents": [
            "initiating action before circumstances become comfortable",
            "meeting opposition with courage and immediate force",
            "making rapid decisions when delay would worsen the outcome",
            "assuming command in dangerous or demanding conditions",
            "recovering momentum quickly after conflict or defeat",
        ],
        "challenges": [
            "acting before consequences have been properly judged",
            "turning disagreement into an unnecessary contest",
            "abandoning efforts that no longer provide immediate movement",
            "using force where patience or strategy would work better",
            "mistaking readiness to act for complete preparation",
        ],
        "greatest_fears": [
            "being rendered powerless at the moment action is required",
            "submission to timid or obstructive authority",
            "public defeat after taking the lead",
            "being trapped in conditions that permit no initiative",
        ],
        "motivations": [
            "freedom of action",
            "victory through courage and effort",
            "testing strength against real resistance",
            "being first to confront what others avoid",
        ],
    },
    ...
    "taurus": {
        ...
        "talents": [
            "preserving resources through patience and consistent effort",
            "building material value that can survive temporary reversals",
            "judging quality through practical and sensory evidence",
            "maintaining routines on which other people can depend",
            "cultivating land, wealth, craft, or comfort over time",
        ],
        "challenges": [
            "remaining fixed after circumstances genuinely require movement",
            "mistaking familiarity for safety and possession for security",
            "becoming territorial about resources, habits, and relationships",
            "yielding excessively to appetite, luxury, or physical comfort",
            "responding to pressure with immobility rather than adaptation",
        ],
        "greatest_fears": [
            "material instability",
            "loss of accumulated resources",
            "being forced into sudden and poorly considered change",
            "dependence on unreliable people or conditions",
        ],
        "motivations": [
            "tangible security",
            "productive continuity",
            "ownership and stewardship",
            "creating value that can be retained and enjoyed",
        ],
    },
    ...
    "gemini": {
        ...
        "talents": [
            "connecting information through speech, writing, and calculation",
            "adapting language and method to different people and purposes",
            "learning practical distinctions with unusual speed",
            "facilitating trade, correspondence, negotiation, and exchange",
            "holding several lines of inquiry in motion at once",
        ],
        "challenges": [
            "substituting verbal facility for settled understanding",
            "scattering attention across too many simultaneous interests",
            "changing positions whenever a more convenient argument appears",
            "using ambiguity to avoid responsibility for a definite choice",
            "collecting information without organizing it into judgment",
        ],
        "greatest_fears": [
            "intellectual confinement",
            "being unable to communicate or obtain needed information",
            "commitment to an explanation that cannot be revised",
            "mental inactivity and repetitive isolation",
        ],
        "motivations": [
            "knowledge through comparison",
            "communication",
            "mobility between people, subjects, and methods",
            "the useful circulation of ideas and information",
        ],
    },
    ...
    "cancer": {
        ...
        "talents": [
            "creating shelter and continuity for family or community",
            "responding quickly to changes in the surrounding emotional climate",
            "preserving memory, ancestry, and inherited forms of belonging",
            "nourishing vulnerable people through practical attention",
            "protecting domestic life with persistent care",
        ],
        "challenges": [
            "allowing changing feelings to redirect settled decisions",
            "clinging to inherited attachments after their purpose has ended",
            "retreating into silence instead of stating needs plainly",
            "turning care into dependency or possessiveness",
            "judging present conditions primarily through memory",
        ],
        "greatest_fears": [
            "loss of home or family continuity",
            "being unable to protect those who depend on them",
            "separation from ancestry, memory, or belonging",
            "exposure without a secure place of return",
        ],
        "motivations": [
            "emotional and domestic security",
            "caregiving",
            "continuity of family and tradition",
            "creating a protected place in which life can develop",
        ],
    },
    ...
    "leo": {
        ...
        "talents": [
            "assuming visible responsibility for collective direction",
            "commanding attention through confidence and personal authority",
            "maintaining courage when leadership carries public consequences",
            "protecting dependents through loyalty and strength",
            "establishing standards of conduct through personal example",
        ],
        "challenges": [
            "treating disagreement as an offense against rightful authority",
            "becoming rigid when dignity would be better served by adaptation",
            "demanding recognition as proof of loyalty",
            "confusing generosity with entitlement to obedience",
            "concealing ordinary vulnerability behind pride",
        ],
        "greatest_fears": [
            "public humiliation",
            "loss of authority",
            "failure to protect or properly lead their dependents",
            "being treated as dishonorable or insignificant",
        ],
        "motivations": [
            "honor",
            "legitimate authority",
            "recognition for courageous leadership",
            "the power to direct and protect what has been entrusted to them",
        ],
    },
    ...
    "virgo": {
        ...
        "talents": [
            "distinguishing useful particulars from error and excess",
            "improving work through exact calculation and skilled technique",
            "organizing health, service, records, and routine obligations",
            "translating general intentions into workable procedure",
            "applying intelligence to crafts that require patience and detail",
        ],
        "challenges": [
            "allowing minor defects to outweigh the value of the whole",
            "revising work beyond the point of practical improvement",
            "turning concern about error into chronic worry",
            "judging people primarily by usefulness and correct conduct",
            "withholding action until every detail appears controlled",
        ],
        "greatest_fears": [
            "avoidable error",
            "impurity, disorder, or neglected obligation",
            "being found technically unprepared",
            "failing in a duty that careful attention could have secured",
        ],
        "motivations": [
            "discernment",
            "competent service",
            "technical mastery",
            "the orderly completion of necessary work",
        ],
    },
    ...
    "libra": {
        ...
        "talents": [
            "weighing competing interests before reaching an agreement",
            "recognizing value, proportion, and exchange with social accuracy",
            "conducting trade, contracts, and negotiation advantageously",
            "reducing friction through tact, presentation, and timing",
            "creating workable reciprocity between unequal positions",
        ],
        "challenges": [
            "delaying judgment while continuing to compare advantages",
            "trading conviction for approval or immediate agreement",
            "treating relationships too much like negotiations of value",
            "using attractiveness or courtesy to conceal self-interest",
            "preferring an elegant settlement to a truthful reckoning",
        ],
        "greatest_fears": [
            "open conflict that destroys the possibility of agreement",
            "an exchange in which they possess no bargaining position",
            "social disgrace or rejection",
            "making an inequitable choice that cannot be renegotiated",
        ],
        "motivations": [
            "equitable exchange",
            "partnership",
            "social and material reciprocity",
            "establishing terms under which opposing interests can coexist",
        ],
    },
    ...
    "scorpio": {
        ...
        "talents": [
            "detecting concealed danger, hostility, or weakness",
            "remaining effective in secretive and high-pressure conditions",
            "protecting sensitive knowledge and shared resources",
            "investigating matters that resist superficial examination",
            "committing force and endurance to a decisive objective",
        ],
        "challenges": [
            "treating uncertainty as evidence of concealed hostility",
            "holding injuries in reserve for later retaliation",
            "using secrecy and pressure to control exposed situations",
            "remaining fixed in anger after the original danger has passed",
            "making trust dependent on repeated tests of loyalty",
        ],
        "greatest_fears": [
            "betrayal from within a protected alliance",
            "loss of control over dangerous or confidential matters",
            "being exposed to an adversary who knows their vulnerabilities",
            "failing to detect a hidden threat before it becomes active",
        ],
        "motivations": [
            "strategic security",
            "loyalty proven under pressure",
            "mastery of concealed or dangerous conditions",
            "finding the operative cause beneath misleading appearances",
        ],
    },
    ...
    "sagittarius": {
        ...
        "talents": [
            "directing effort toward distant and meaningful aims",
            "teaching principles that organize otherwise scattered knowledge",
            "connecting law, ethics, belief, and conduct",
            "offering counsel from a broad understanding of consequences",
            "sustaining confidence through study, pilgrimage, or purposeful travel",
        ],
        "challenges": [
            "forcing evidence to serve a preferred doctrine",
            "treating confidence as proof that judgment is correct",
            "promising more than time or resources can support",
            "using moral standing to excuse carelessness",
            "pursuing distant aims while neglecting immediate duties",
        ],
        "greatest_fears": [
            "a life without moral or intellectual direction",
            "ignorance that prevents sound judgment",
            "dishonor through failure to uphold professed principles",
            "confinement to obligations that serve no larger purpose",
        ],
        "motivations": [
            "dharma",
            "wisdom",
            "teaching and guidance",
            "movement toward an aim worthy of sustained belief",
        ],
    },
    ...
    "capricorn": {
        ...
        "talents": [
            "advancing through difficult material conditions without wasting effort",
            "organizing labor, hierarchy, and limited resources",
            "accepting long obligations whose rewards arrive gradually",
            "building authority through endurance and demonstrated competence",
            "making practical decisions within unavoidable constraints",
        ],
        "challenges": [
            "treating hardship as the only reliable measure of worth",
            "placing rank and utility above affection or personal ease",
            "becoming severe when fear of failure takes command",
            "carrying burdens that should be delegated or abandoned",
            "mistaking pessimism for practical judgment",
        ],
        "greatest_fears": [
            "material failure after prolonged effort",
            "loss of rank, livelihood, or dependable structure",
            "dependence without authority",
            "being unable to discharge an important duty",
        ],
        "motivations": [
            "durable accomplishment",
            "earned authority",
            "material competence",
            "the orderly fulfillment of consequential duties",
        ],
    },
    ...
    "aquarius": {
        ...
        "talents": [
            "understanding the systems that distribute resources across groups",
            "maintaining collective structures through persistence and restraint",
            "judging social conditions without excessive personal favoritism",
            "containing and preserving resources for later circulation",
            "working patiently with large populations or long institutional cycles",
        ],
        "challenges": [
            "becoming emotionally remote in the name of impartiality",
            "preserving an impersonal system after it has ceased to serve people",
            "withholding resources through fear of future scarcity",
            "accepting social isolation as the price of rigid principle",
            "reducing individual needs to abstract collective categories",
        ],
        "greatest_fears": [
            "exclusion from a sustaining community or network",
            "collective scarcity",
            "failure of the systems on which many people depend",
            "personal obligation that overwhelms their wider responsibilities",
        ],
        "motivations": [
            "durable collective order",
            "fair distribution of limited resources",
            "usefulness within a larger social structure",
            "maintaining systems that outlast individual preference",
        ],
    },
    ...
    "pisces": {
        ...
        "talents": [
            "reconciling practical life with spiritual or ethical meaning",
            "offering compassionate counsel without reducing life to rigid rules",
            "synthesizing many impressions into an inclusive understanding",
            "recognizing when completion, forgiveness, or release is necessary",
            "using imagination in the service of devotion, wisdom, or benevolence",
        ],
        "challenges": [
            "trusting benevolent appearances without sufficient discrimination",
            "substituting faith or generosity for practical boundaries",
            "withdrawing when material duties become disagreeable",
            "allowing sympathy to weaken necessary judgment",
            "moving between convictions without completing their practical demands",
        ],
        "greatest_fears": [
            "a life emptied of spiritual or moral significance",
            "separation from faith, guidance, or compassionate fellowship",
            "causing suffering through hardness of judgment",
            "remaining bound to conditions that permit no meaningful release",
        ],
        "motivations": [
            "wisdom joined with compassion",
            "devotion",
            "benevolent guidance",
            "completion that permits forgiveness, release, and renewal",
        ],
    },
}
...
SENTIMENT_COLORS = {
    ...
    "protect": "#0000ff",
    "intriguing":"#754db3",
    "broadly relatable":"#33ccff",
    "intellectually relatable":"#33ccff",
    "emotionally relatable":"#33ccff",
    "similar values":"#33ccff",
    "similar interests":"#33ccff",
    "similar mannerisms":"#33ccff",
    "similar background":"#33ccff",
    "hilarious":"#ffd966",
    "ineffable":"#c92bfb",
#neg
    "frustrating":"#993300",
