...
#Positions and aspects must be parsed differently. First, parse the position string so it's algorithmically recognizeable with actual chart positions in the given chart. Then - if take that chart's sign weight, body weight and house weight
    1:{
    "signs":{"Virgo","Capricorn","Aquarius","Scorpio"},
    "houses":{10},
    "bodies":{"Saturn","Venus"},
    "nakshatras":{"Purva Ashadha","Mrigashira","Mula","Krittika"},
    "positions":{},
    "aspects":{},
    "color":"#f5f5f5",
    ...
    2:{
    "signs":{"Cancer","Pisces","Scorpio","Capricorn"},
    "houses":{7,12,4},
    "bodies":{"Venus","Ceres","Chiron","Neptune"},
    "nakshatras":{"Bharani","Rohini","Punarvasu","Pushya","Uttara Phalguni"},
    "positions":{"Moon in Cancer","Chiron in Pisces","Ceres in Pisces","Mars in Pisces","Vesta in H4", "Taurus in H10","Neptune in H4","Ceres in H11",""},
    "aspects":{"Ceres sextile Mercury","Chiron trine Vesta","Chiron trine True Lilith","Juno trine Neptune","Mercury trine Neptune","Ketu trine Venus","Ketu square Venus"},
    "color":"#cc9900",
    ...
    "houses":{6,2,4},"bodies":{"Moon","Saturn"},
    "nakshatras":{"Uttara Ashadha","Pushya"},
    "positions":{},
    "aspects":{},"color":"#0099cc",
