...
#Positions and aspects must be parsed differently. First, parse the position string so it's algorithmically recognizeable with actual chart positions in the given chart. Then - if take that chart's sign weight, body weight and house weight
    1:{"signs":{"Virgo","Capricorn","Aquarius"},"houses":{10},"bodies":{"Saturn","Venus"},"nakshatras":{"Purva Ashadha","Mrigashira","Mula","Krittika"},"positions":{},"aspects":{},"color":"#f5f5f5","motivation":"Perfection, correctness","description":"1s dream of a better world, which begins with themselves. Their scope for seeking the betterness of things may occupy any scale - personal (rigorous regimen to become virtuosic and/or to obliterate one's personal flaws), intimate (seeking to correct the flaws of others), or global/collective (trying to correct perceived flaws in the world and/or its systems at large).","quotes":{"'I don't care it  it hurts. / I want to have control. / I want a perfect body. / I want a perfect soul.' - Thom Yorke, Creep"},},
    2:{"signs":{"Cancer","Pisces","Virgo"},"houses":{7,12,4},"bodies":{"Moon"},"nakshatras":{"Punarvasu","Pushya","Uttara Phalguni"},"positions":{"Moon in Cancer"},"aspects":{},"color":"#cc9900","motivation":"To be useful & necessary to others","description":"2s want to be indispensible to others. They need to be needed. They can only feel that they matter if others depend on them.","quotes":{"'When you're weary / Feeling small / When tears are in your eyes / I will dry them all / I'm on your side. / Oh, when times get rough, / And friends just can't be found...' - Simon & Garfunkel, Bridge Over Troubled Water"},},
    3:{"signs":{"Leo","Capricorn","Libra"},"houses":{1,10},"bodies":{"Sun","Jupiter","Venus"},"nakshatras":{"Vishakha","Jyestha","Ashlesha","Magha",},"positions":{},"aspects":{},"color":"#ffff00","motivation":"Visible recognitition, status and achievement","description":"3s are sort of narcissist-coded, but that doesn't have to be malignant. It can result in materialism, or it could result in extreme competence. Sometimes 3s are mistaken for 1s because they appear driven by perfectionism. But rather than pursuit of perfection/ideals (e1) or competence (e5) for their own sake, 3s are driven by the pursuit of recognition for that competence. Arguably, the easier the trophies and acolades come, the less hard 3s will need to try. The point here is not the conditions of victory, but the recognition of their superiority over others; the status and attention of being president more than the power of owning the red button. They will live and die for that gold star on their paper, and the knowledge that other people know they got it.","quotes":{"'There's been a lot of compromisin' / on the road to my horizon... / but I'm gonna be / where the lights are shinin' on me...' - Glen Camphell, Rhinestone Cowboy"},},
    4:{"signs":{"Pisces","Aquarius","Scorpio"},"houses":{1},"bodies":{"Uranus"},"nakshatras":{"Ardra","Purva Bhadrapada","Revati"},"positions":{"Mercury in Pisces","Mars in Pisces"},"aspects":{},"color":"#cc66ff","motivation":"Individuality, depth of experience & authenticity","description":"4s want a genuine experience, be it the depths of pain or pleasure. They want beauty, but see beauty and truth as inseparable, so we aren't talking Kpop symmetry and Kardashians; we're talking scar-faced midwives, Edward James Olmos' face, Bukowski poems, Philip-Lorca diCorcia photos, Disco Elysium, David Lynch and Adrienne Shelly indie flicks. They can be goth-coded, but they aren't all goths. There's a lot of BS backstory lore on e4s by major voices in Enneagram theory who say stuff like 'e4s feel there's an essential part of themselves missing' or are driven by self-pity and similar nonsense. It's all rubbish written by people who clearly don't understand them. Like their moms. *slams door*","quotes":{"'Drink up one more time / and I'll make you mine, / keep you apart, / deep in my heart / separate from the rest, / where I like you the best-- / and keep the things you forgot...' - Elliott Smith, Between the Bars","'Baby, do you understand me now? / Sometimes I feel a little mad... / Don't you know no one alive can always be an angel.../ When things go wrong, I seem to be bad@  - The Animals, Don't Let Me Be Misunderstood","Marge: Why all the black? / Homer: Why all the pearls? Why all the hair? Why anything? - The Simpsons"},},
    5:{"signs":{"Gemini","Aquarius","Aries","Virgo"},"houses":{3,9},"bodies":{"Mercury","Pluto"},"nakshatras":{"Swati","Anuradha","Shatabhisha"},"positions":{"Mercury in Gemini","Mercury in Virgo","Mercury in Scorpio","Mercury in Aquarius"},"aspects":{},"color":"#669900","motivation":"Knowledge & information, personal autonomy","description":"5s want to understand the world, whether through a microscope or a telescope. They generally perceive themselves as on the outside, looking in at the experiment of existence. They go to great pains to ensure that their lab is protected so that their subjects (the outside world) cannot touch them, messy their lab and disrupt their experiments.","quotes":{},},
    6:{"signs":{"Taurus","Libra","Cancer"},"houses":{6,2,4},"bodies":{"Moon","Saturn"},"nakshatras":{"Uttara Ashadha","Pushya"},"positions":{},"aspects":{},"color":"#0099cc","motivation":"Duty, performing perceived social role & fulfilling personal responsibilities.","description":"6s are generally here to maintain their view of the status quo, upholding their recognized hierarchy, and support their tribe. This can look very different depending on who they recognize as their authority figure (leader), and who/what they believe is their tribe (which can exist at varying scales from the very personal to the very global). Independent of scale, they will expect members of their perceived tribe to fulfill their responsibilities/duties/roles within the tribe as well. In the creator of this app's opinion, there is no 'counterphobic 6' as lore suggests - just one type of 6, who is always deferential to role models, even if the early Recognized Tribal Authority was Hunter S Thompson, Charlton Heston or the Unibomber. Saying e6 is about 'security' is tautological; the entire enneagram is about how individuals seek a sense of security; e6 seeks it through tribal role participation'.","quotes":{"'If I'd said that to MY daddy, he'd have...[insert reflection on one's father's archetypal behavior, intended as a model of exemplary response to the situation]' - a phrase often invoked by nearly everyone in the American South & Bible Belt."},},
    7:{"signs":{"Gemini","Sagittarius","Pisces"},"houses":{5},"bodies":{"Jupiter","Sun"},"nakshatras":{"Rohini","Ashwini","Shravana","Purva Phalguni"},"positions":{},"aspects":{},"color":"#ff33cc","motivation":"Escaping adversity, embracing pleasure","description":"Essentially, 7s are about a blend of hedonism and epicurianism. They are here to enjoy life, and avoid what detracts from that enjoyment.","quotes":{"'Hey, I just met you / and this is crazy / but here's my number / so call me maybe...' - Carly Rae Jepsen, Call Me Maybe","'This is the day you will always remember as the day you almost caught Captain Jack Sparrow.' - Capt. Jack Sparrow, Pirates of the Caribbean","'What’s the hassle, Schmasel?' - Bugs Bunny","'Well, like the Romans always say … E pluribus uranium.' - Bugs Bunny"},},
    8:{"signs":{"Aries","Sagittarius","Leo","Scorpio"},"houses":{8},"bodies":{"Mars","Pluto"},"nakshatras":{"Jyestha","Purva Bhadrapada","Krittika","Chitra"},"positions":{"Moon in Aries"},"aspects":{},"color":"#ff0000","motivation":"Personal sovereignty, dominance, asserting control","description":"3s may pursue dominance through material recognition and social status. 8s will pursue it by any means necessary. Power not for social validation, not as a conditioned social response that recognizes and values the established institutions and wishes to perform within them, but potentially outside them. Whatever it takes to be in control, or at very least to avoid being controlled by others.","quotes":{"'You know the way to stop me / but you don't have the discipline. / How many nights have I prayed for this? / To let my work begin...! / First we take Manhattan... / then we take Berlin!' - Leonard Cohen, First We Take Manhattan","'They’re whispering his name across this disappearing land / But hidden in his coat is a red right hand... / You ain’t got no money? / He’ll get you some / You ain’t got no car? / He’ll get you one / You ain’t got no self-respect, you feel like an insect / Well don’t you worry buddy, cause here he comes...' - Nick Cave, Red Right Hand"},},
    9:{"signs":{"Pisces","Libra","Scorpio"},"houses":{12},"bodies":{"Neptune"},"nakshatras":{"Dhanishta","Uttara Bhadrapada","Ashwini"},"positions":{""},"aspects":{},"color":"#cc99ff","motivation":"Tranquility. Maintaining harmony at any cost","description":"9s just want peace. They want everyone to get along. Unlike 1s, they won't generally lash out at those disrupting the peace, but will quietly brood and retreat from those who cause chaos and disharmony. If they ever choose to stand for anything, it would likely be a stand for nonviolence, a stand to end conflict. They can be hard to recognize because they often adapt & shapeshift as a means of keeping peace.","quotes":{"'Well, you may say that I'm a dreamer / but I'm not the only one. / I hope someday you'll join us... / and the world can live as one.' - John Lennon, Imagine"},},
...
ENNEAGRAM_VARIANTS = { #the scale/scope of one's focus. Gemini has no evident preference, as far as I can tell. Capricorns technically operate at any scope, but their bottom line is always sp, I think.
    ...
    "so":{"signs":{"Aquarius","Leo","Libra",},"houses":{9,10,11},"bodies":{},"nakshatras":{},"positions":{},"aspects":{},"color":"","description":"",},
}
