...
NAKSHATRA_DESCRIPTIONS = {
    ...
    "Punarvasu": {
        ...
        "archetypes": "Ugly curse - beast needs love to heal/become beautiful (mostly male trope). #3 richest moon. #3 in ugly duckling glow up plots. Alt kids & offbeat beatnics. Vulnerable to golddiggers & con artists. Do not deny their boundless primal urges.",
        "deity": "Guru",
        "ruler": "Jupiter",
    ...
    "Purva Bhadrapada": {
        ...
        "archetypes": "Kali the Destroyer; serial killer & MMA (moon). #4 occultist (dom). Femme fatales. Ugly duckling glow up plots. Outsiders.  Do not deny their boundless primal urges.",
        "deity": "Guru",
        "ruler": "Jupiter",
        "planetary_associations": "Neptune/Jupiter",
        "comments_A": "",
