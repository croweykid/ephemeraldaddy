...
class Chart:
    ...
    def as_dict(self):
        return {
            ...
            "predicted_traits_above_avg": sorted(getattr(self, "predicted_traits_above_avg", set()) or []),
            "predicted_traits_below_avg": sorted(getattr(self, "predicted_traits_below_avg", set()) or []),
            "predicted_trait_deviations": dict(getattr(self, "predicted_trait_deviations", {}) or {}),
