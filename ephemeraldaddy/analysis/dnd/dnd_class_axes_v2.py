...
CLASS_DISTRIBUTION_CALIBRATION: Dict[str, float] = {
    # Pull chronic over-selection down slightly.
    "Wizard": 0.90,
    "Bard": 0.91,
    "Barbarian": 0.92,
    # Lift under-selected lanes.
    "Cleric": 1.10,
    "Fighter": 1.10,
    "Warlock": 1.08,
}
...
def build_dnd_statblock_profile_lines(
    ...
    *,
    ...
    from .dnd_stat_calculator import build_dnd_statblock_profile_lines as _build_dnd_statblock_profile_lines

    return _build_dnd_statblock_profile_lines(
        statblock,
        bar_width=bar_width,
        floor=floor,
        ceiling=ceiling,
