...
**Last implementation audit:** 2026-09-11 (`4e4c1fa`)
...
keyword/token model family have canonical owners and focused regression
coverage. `app.py` is still 39,367 lines with 1,060
