...
keyword, token, decan, and mode model family, and Chart Editor save-result/time
reliability lifecycle state have canonical owners and focused regression
coverage. `app.py` is still 39,330 lines with 1,061
